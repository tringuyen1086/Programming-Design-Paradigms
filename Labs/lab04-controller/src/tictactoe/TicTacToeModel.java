...
/**
 * The model class for the Tic Tac Toe game
 * Represents a single game of Tic Tac Toe. Three in a row
 * down/across/diagonally to win; X goes first.
 * This class implements the TicTacToe interface and handles game state, moves,
 */
public class TicTacToeModel implements TicTacToe {
  ...
  public TicTacToeModel() {
    board = new Player[3][3]; // Initialize an empty 3x3 board
    turn = Player.X; // X starts first
  }
